...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="gambar"><img width="500" height="500" src="/image/thomath.png"></div>
      ...
      <h5><span class="head" style="font-size: medium; font-weight: normal; margin-left: 3px;">Belajar seru bersama kami!!</span></h5>
      <div class="d-flex flex-sm-row flex-column align-items-center mx-auto mx-lg-0 justify-content-center gap-3">
        <button class="btn btn-get d-inline-flex" style="margin-top: -700px; margin-left: -1010px; background-color:rgb(185, 39, 39); color: white; font-family: sans-serif; font-size: medium;">Get Started</button>
    </div>
</body>
</html>